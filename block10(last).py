...
# 模擬資料
fps_data = {
    "Model Name": ["Ours", "YOLOv10s","YOLOv10s+Ghostnet","YOLOv10s+swin"],
    "Jetson(Orin NX, 15W)": [42.07, 13.09, 13.55, 10.61],
    "Laptop(NVIDIA GeForce GTX 1650 Ti)": [212.32, 60.47, 68.21, 52.99],
    "Desktop(NVIDIA GeForce RTX 2080 Ti)": [499.66, 169.77, 227.61, 170.27],
    "Desktop(NVIDIA GeForce RTX 4090 )": [770.18, 380.21, 453, 401.35]   
    }
