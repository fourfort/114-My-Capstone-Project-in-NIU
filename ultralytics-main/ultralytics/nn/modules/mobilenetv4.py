...
@register_model("mobilenetv4_conv_large_custom")  # 原本 mobilenetv4_conv_large
def mobilenetv4_conv_large(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = MobileNetV4('MobileNetV4ConvLarge', **kwargs)
    return model
 
@register_model("mobilenetv4_hybrid_medium_custom")  # 原本 mobilenetv4_hybrid_medium
...
@register_model("mobilenetv4_hybrid_large_custom")  # 原本 mobilenetv4_hybrid_large
