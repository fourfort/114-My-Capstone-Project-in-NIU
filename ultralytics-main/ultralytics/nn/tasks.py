...
from ultralytics.nn.modules.liteshufflenet import liteShuffleNetV2,liteConv_maxpool  
import torch
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]] 
        elif m in [liteShuffleNetV2, liteConv_maxpool]:
            c1, c2 = ch[f], args[0]
            if c2 != nc:  # if c2 not equal to number of classes (i.e. for Classify() output)
                c2 = make_divisible(c2 * width, 8)
            args = [c1, c2, *args[1:]]   
            ...
            if m is HGBlock:
                ...
                n = 1
        elif m in (mobilenetv4_conv_large, ghostnetv3):
            m = m(*args)
            c2 = m.channels
