...
# 模擬數據
fps_data = {
    "Name": ["Ours", "YOLOv10s", "YOLOv10s+Ghostnet", "YOLOv10s+swin"],
    "layers": [474, 402, 506, 435],
    "parameters": [7048314, 8068674, 7177898, 8038470],
    "GFLOPS": [4.24, 24.77, 17.65, 24.38],
    "epoch": [492, 469, 511, 321]
}
