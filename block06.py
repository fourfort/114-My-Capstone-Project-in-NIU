...
# 模擬資料
fps_data = {
    "Model Name": ["Ours", "YOLOv11s+CSPliteshufflenetV2", "YOLOv8s", "YOLOv11s", "YOLOv8s+Ghostnet", "YOLOv8s+Swin","YOLOv10s","YOLOv10s+CSPliteshufflenetV2","YOLOv9s","YOLOv9s+CSPliteshufflenetV2"],
    "Jetson(Orin NX)": [30.21, 26.15, 18.14, 16.77, 17.35, 13.08,13.09,42.07,12.54,25.6],
    "Laptop(NVIDIA GeForce GTX 1650 Ti)": [118.59, 104.57, 69.59, 63.84, 82.94, 59.16,60.47,212.32,60.98,137.73],
    "Desktop(NVIDIA GeForce RTX 2080 Ti)": [368.78, 300.30, 228.68, 194.52, 277.37, 189.44,169.77,499.66,163.73,378.26],
    "Desktop(NVIDIA GeForce RTX 4090 Ti)": [702.37, 574.38, 427.94, 389.91, 421.51, 348.14,380.21,770.18,362.98,519.92]   
    }
...
# 選擇要根據哪個裝置的 FPS 來排序 legend（例如 RTX 4090 Ti）
device_for_legend = "Desktop(NVIDIA GeForce RTX 4090 Ti)"
