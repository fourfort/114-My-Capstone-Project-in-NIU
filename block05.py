...
# 模擬數據
fps_data = {
    "Name": ["Ours", "YOLOv8s", "YOLOv8s+Swin",  "YOLOv8s+Ghostnet", "YOLOv8s+GEShufflenetV2", "YOLOv8s+ShufflenetV2"],
    "layers": [284, 225, 258,  529, 334, 235],
    "parameters": [6423609, 11136761, 11106557,  9480276, 5589485, 6388657],
    "GFLOPS": [16.417, 28.651, 32.098, 16.498, 15.416,16.498],
    "epoch": [198, 186, 162, 588, 470, 248]
}
